...
class DateControlTest extends SimpleControlTest
{
  ...
  public function testHtml(): void
  {
    ...
    $html     = $form->getHtml();
    $expected = '<form method="post" action="/"><fieldset><input type="date" name="myForm[myFieldSet][myInput]"/></fieldset></form>';
  ...
  private function openDateTest(string $openDateStart, string $openDateEnd): void
  {
    ...
    self::assertStringContainsString('<input type="date" name="date_start"/', $html);
    self::assertStringContainsString('<input type="date" name="date_end"/', $html);
  }
}
