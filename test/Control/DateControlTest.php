...
class DateControlTest extends SimpleControlTest
{
  ...
  private function openDateTest(string $openDateStart, string $openDateEnd): void
  {
    ...
    self::assertStringContainsString('<input class="frm frm-input" type="date" name="date_start"/', $html);
    self::assertStringContainsString('<input class="frm frm-input" type="date" name="date_end"/', $html);
  }
}
